...
$result = $conn->query("SELECT * FROM medicines WHERE quantity <= 20 OR status IN ('Low Stock','Out of Stock') ORDER BY quantity ASC, medicine_name ASC");

require_once __DIR__ . '/includes/header.php';
?>
<div class="page-header">
  <div><h1>⚠️ Low Stock Alerts</h1><p>Medicines with 20 or fewer units remaining</p></div>
